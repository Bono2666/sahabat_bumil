                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.connectionState == ConnectionState.done) {
                          ...
                          for (int i=0; i < dbBranch.length; i++) {
                            if (double.parse(dbBranch[i]['branch_latitude']) != 0) {
                              double startLat = prefs.getCurrLat;
                              double startLong = prefs.getCurrLong;
                              double endLat = double.parse(dbBranch[i]['branch_latitude']);
                              double endLong = double.parse(dbBranch[i]['branch_longitude']);
