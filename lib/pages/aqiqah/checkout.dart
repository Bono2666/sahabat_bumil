...
class _CheckoutState extends State<Checkout> {
  List dbSetup, dbProduct, response;
  int jmlPesan = 1;
  int totOrder = 0;
                                ...
                                Expanded(
                                  child: SizedBox(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          dbProduct[0]['package'] + ' - ' + dbProduct[0]['name'],
                            ...
                            onTap: () {
                              ...
                              launch('https://api.whatsapp.com/send?phone=' + dbSetup[0]['wa_number'] +
                                  '&text=Assalamualaikum%2C%0D%0A%0D%0ASaya+melihat+di+aplikasi+Sahabat+Bumil%2C+'
                                      'dan+tertarik+dengan%0D%0A%0D%0A*' + dbProduct[0]['package'] + ' - ' +
                              ...
                              totOrder = int.parse(dbProduct[0]['total_order']) + jmlPesan;
                              updTotalOrder();
