...
class _NewQuestionState extends State<NewQuestion> {
  ...
  Future getNotifications() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/get_notifications.php?phone=${prefs.getPhone}');
  ...
  Future addQuestion() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/add_question.php');
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        'Ayah/Bunda belum melengkapi judul pertanyaan dan persoalan, mohon dilengkapi dulu ya...',
                                        style: TextStyle(
