...
class _UpdSchedState extends State<UpdSched> {
  ...
  Future addSchedule() async {
    var url = 'https://sahabataqiqah.co.id/sahabat_bumil/api/add_schedule.php';
  ...
  Future updSchedule() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/upd_single_sched.php?phone=${prefs.getPhone}&time=${prefs.getSchedTime}&title=${prefs.getSchedTitle}&date=${prefs.getSchedDate}&new_title=${_title.text}&new_date=$_scheduleDate&new_time=${_time.text}&new_notes=${_notes.text}');
