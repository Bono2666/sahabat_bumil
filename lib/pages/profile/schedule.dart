...
class _ScheduleState extends State<Schedule> {
  ...
  Future getSchedule() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/get_schedule.php?phone=${prefs.getPhone}&date=${DateFormat('yyyy-MM-dd').format(_focusedDay)}');
    var response = await http.get(url);
    return json.decode(response.body);
  }

  Future updSchedule() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/upd_check_sched.php?phone=${prefs.getPhone}&time=$_time&title=$_title&is_done=$isDone&date=${DateFormat('yyyy-MM-dd').format(_focusedDay)}');
    var response = await http.get(url);
    return json.decode(response.body);
  }

  Future delSchedule(int index) async {
    var url = 'https://sahabataqiqah.co.id/sahabat_bumil/api/del_schedule.php';
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: FittedBox(
                                                child: dbSchedule[index]['is_done'] == '0'
                                                    ? Image.asset('images/ic_discheck.png')
