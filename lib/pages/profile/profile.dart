...
class _ProfileState extends State<Profile> {
  ...
  Future upload() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/upload_avatar.php');
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Visibility(
                                    visible: dbUser[0]['name'].toString().isEmpty && prefs.getName == '' ? false : true,
                                    child: Text(
                                      dbUser[0]['name'].toString().isEmpty ? prefs.getName : dbUser[0]['name'],
                                      style: TextStyle(
                                        fontSize: 16.0.sp,
