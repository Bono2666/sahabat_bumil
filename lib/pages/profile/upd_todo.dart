...
class _UpdTodoState extends State<UpdTodo> {
  ...
  Future addTodo() async {
    var url = 'https://sahabataqiqah.co.id/sahabat_bumil/api/add_todo.php';
  ...
  Future updTodo() async {
    var url = Uri.parse('https://sahabataqiqah.co.id/sahabat_bumil/api/upd_single_todo.php?id=${prefs.getTodoId}&new_title=${_title.text}');
